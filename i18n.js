...
const TRANSLATIONS = {
  ...
  pt: {
    ...
    'secret-opt-highlight-desc': 'Realça brevemente a palavra corrigida durante 5 segundos',
  ...
  en: {
    ...
    'secret-opt-highlight-desc': 'Briefly highlight the corrected word for 5 seconds',
    ...
    'ach-corrections-10000-desc': 'Have 10,000 words corrected. IT\'S OVER 9000!',
  },
  es: {
    ...
    'secret-opt-highlight-desc': 'Resalta brevemente la palabra corregida durante 5 segundos',
  ...
  fr: {
    ...
    'secret-opt-highlight-desc': 'Met brièvement en surbrillance le mot corrigé pendant 5\u00A0seconde',
  ...
  de: {
    ...
    'secret-opt-highlight-desc': 'Hebt das korrigierte Wort kurz für 5 Sekunden hervor',
  ...
  zh: {
    ...
    'secret-opt-highlight-desc': '短暂高亮已更正的单词，持续5秒',
