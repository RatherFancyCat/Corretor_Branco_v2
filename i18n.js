...
const TRANSLATIONS = {
  ...
  pt: {
    ...
    'secret-opt-cursorlocator-desc':'Prima Alt+Q para mostrar exatamente onde estás a escrever na página',
  ...
  en: {
    ...
    'secret-opt-cursorlocator-desc':'Press Alt+Q to show exactly where you are typing on the page',
  ...
  es: {
    ...
    'secret-opt-cursorlocator-name':'🎯 Localizador de Cursor',
    'secret-opt-cursorlocator-desc':'Pulsa Alt+Q para mostrar exactamente dónde estás escribiendo en la página',
  ...
  fr: {
    ...
    'secret-opt-cursorlocator-desc':"Appuyez sur Alt+Q pour afficher exactement où vous écrivez sur la page",
    'secret-xpbar-lvl':             'NIV:',
  ...
  de: {
    ...
    'secret-opt-cursorlocator-desc':'Drücke Alt+Q, um genau zu sehen, wo du auf der Seite schreibst',
    'secret-xpbar-lvl':             'LVL:',
  ...
  zh: {
    ...
    'secret-opt-cursorlocator-desc':'按 Alt+Q 显示您在页面上的确切输入位置',
    'secret-xpbar-lvl':             '等级:',
